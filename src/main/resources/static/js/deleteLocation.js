$(document).ready(function(e){
    var banner = '<h1>Choose a Location to Delete</h1>';
    var div = $('#banner');
    div.html("");
    div.append(banner);
    ...
    $.ajax({
        ...
        success: function(array) {
            ...
            $.each(array, function(index, location) {
                ...
                superInfo += '<form method="POST" action="/superhero/deleteLocation/' + location.id + '" th:action="@{/superhero/deleteLocation/}" th:object="${location}">';
